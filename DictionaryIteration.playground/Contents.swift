...
if let nirvanaAlbum = bandsHighestSellingAlbum[bandName] {
print("\(bandName)'s top-selling album was \(nirvanaAlbum)")
}
/*: question5
 ...
 */
for (band, album) in bandsHighestSellingAlbum {
 ...
 */
// Create a dictionary that has the grade as the key and the average score of the grade as a value.
/*: question8
